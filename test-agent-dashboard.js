...
async function testAgentMe() {
  ...
  try {
    ...
    console.error("❌ Agent Me API test failed");
    return null;
  }
}
...
async function testDashboardStats() {
  ...
  try {
    ...
    console.error("❌ Dashboard Stats API test failed");
    return null;
  }
}
...
async function testRecentActivity() {
  ...
  try {
    ...
    console.error("❌ Recent Activity API test failed");
    return null;
  }
}
...
async function testSessions(status = "closed") {
  ...
  try {
    ...
    console.error("❌ Sessions API test failed");
    return null;
  }
}
