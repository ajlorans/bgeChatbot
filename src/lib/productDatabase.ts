...
export const products: Product[] = [
  // Eggs
  {
    ...
    description:
      "Our largest EGG, perfect for very large gatherings and commercial use. Can cook up to 20 steaks at once.",
    price: "From $2,649.99",
  ...
  },
  {
    ...
    description:
      "Great for larger families and entertaining. Can cook two 20-pound turkeys at once.",
    price: "From $1,599.99",
  ...
  },
  {
    ...
    description:
      "Perfect for smaller families or limited spaces while still providing plenty of cooking area.",
    price: "From $839.99",
  ...
  // Egg Packages
  {
    ...
    description:
      "Complete package featuring the XL Big Green Egg in a corner modular nest configuration.",
    price: "From $2,429.00",
  ...
  },
  {
    ...
    description:
      "Complete package featuring the Large Big Green Egg in a beautiful acacia hardwood table.",
    price: "From $2,019.00",
  ...
  },
  {
    ...
    description:
      "Complete package featuring the portable MiniMax Big Green Egg with carrier.",
    price: "From $859.00",
  ...
  },
  {
    ...
    description:
      "Complete package featuring the Large Big Green Egg in an intEGGrated nest with handler and side shelves.",
    price: "From $1,849.00",
  ...
  },
  {
    ...
    description:
      "Premium weather-resistant cover designed specifically for the Large EGG in an acacia table.",
    price: "$82.99",
  ...
  },
  {
    ...
    description:
      "Beautiful, durable option that provides ample workspace for your XL EGG.",
    price: "From $699.99",
  ...
  },
  {
    ...
    description:
      "Stylish distressed acacia wood insert for the modular nest system.",
    price: "$104.99",
  ...
  },
  {
    ...
    description:
      "Corner configuration modular nest for the Large Big Green Egg.",
    price: "From $599.99",
  ...
  // Replacement Parts
  {
    ...
    description:
      "High-temperature gasket to ensure a proper seal between the dome and base of your EGG.",
    price: "From $24.99",
  ...
  // Additional products
  {
    ...
    name: "ConvEGGtor",
    description:
      "Essential for indirect cooking, creating a heat barrier between the food and the fire for convection cooking.",
    price: "From $99.99",
  ...
  },
  {
    ...
    description:
      "Perfect for pizzas, breads, desserts and other baked goods. Creates a brick-oven effect for crispy crusts.",
    price: "$69.99",
  ...
  },
  {
    ...
    description:
      "Essential tool for sliding pizzas onto the cooking surface. Thin edge easily slides under pizza and breads.",
    price: "$39.99",
  ...
  },
  {
    ...
    name: "Cast Iron Grid",
    description:
      "Perfect for creating sear marks on steaks and chops. Excellent heat retention for cooking on both sides.",
    price: "From $69.99",
  ...
  },
  {
    ...
    description:
      "Versatile cooking vessel perfect for everything from breakfast to desserts. Pre-seasoned and ready to use.",
    price: "$59.99",
  ...
  },
  {
    ...
    description:
      "Versatile system that allows you to cook multiple dishes at different temperatures simultaneously on your Large EGG.",
    price: "$329.99",
  ...
  },
  {
    ...
    description:
      "Versatile system that allows you to cook multiple dishes at different temperatures simultaneously on your Medium EGG.",
    price: "$299.99",
  ...
  },
  {
    ...
    name: "Grill Gripper",
    description:
      "Essential tool for safely and easily lifting hot cooking grids. Makes handling hot grids safe and simple.",
    price: "$24.99",
  ...
  },
  {
    ...
    name: "Ash Tool",
    description:
      "Designed for safe and easy cleanup of ash after cooking. Cleanly removes ash while protecting the ceramic firebox.",
    price: "$29.99",
  ...
  },
  {
    ...
    description:
      "Quickly and safely lights charcoal without lighter fluid. Gets your EGG ready to cook in minutes.",
    price: "$39.99",
  ...
  },
  {
    ...
    description:
      "100% natural hardwood charcoal for superior flavor. Burns cleaner and longer than briquettes.",
    price: "$29.99",
  ...
  },
  {
    ...
    description:
      "Fast, accurate temperature readings in seconds. Essential for ensuring perfectly cooked meats.",
    price: "$39.99",
  ...
  },
  {
    ...
    description:
      "Monitor food and EGG temperatures from a distance. Includes alerts and preset cooking programs.",
    price: "$99.99",
  ...
  },
  {
    ...
    description:
      "Versatile seasoning blend that enhances the flavor of virtually any food. Perfect for meats, vegetables, and more.",
    price: "$12.99",
  ...
  },
  {
    ...
    description:
      "Sweet and tangy sauce perfect for ribs, chicken, and pork. Made with premium ingredients.",
    price: "$9.99",
  ...
  },
  {
    ...
    name: "Meat Claws",
    description:
      "Perfect tool for shredding pulled pork and handling large cuts of meat. Provides a secure grip for lifting and carrying.",
    price: "$19.99",
  ...
  },
  {
    ...
    description:
      "Holds up to 5 racks of ribs vertically to maximize cooking space. Perfect for smoking multiple racks at once.",
    price: "$34.99",
  ...
  },
  {
    ...
    description:
      "Creates perfectly roasted poultry with crispy skin and moist meat. Cavity holds liquids for added flavor and moisture.",
    price: "$29.99",
  ...
  },
  {
    ...
    description:
      "Perfect for deep dish pizzas, pies, and more. Even heat distribution for perfect results every time.",
    price: "$79.99",
  ...
  },
  {
    ...
    description:
      "Stable base with handles that makes it easy to move your EGG. Includes locking casters for stability.",
    price: "From $199.99",
  ...
  },
  {
    ...
    description:
      "Convenient side shelves that provide workspace while cooking. Folds down when not in use.",
    price: "From $129.99",
  ...
  },
  {
    ...
    description:
      "Catches drippings for easy cleanup. Pack of 5 heavy-duty aluminum pans.",
    price: "$14.99",
  ...
  // Additional Lifestyle & Gear
  {
    ...
    description:
      "High-quality grilling apron with adjustable neck strap and multiple pockets for tools and accessories.",
    price: "$34.99",
  ...
  },
  {
    ...
    description:
      "Stylish cap with embroidered Big Green Egg logo. One size fits most with adjustable strap.",
    price: "$24.99",
  ...
  },
  {
    ...
    description:
      "Flexible LED light that attaches to your EGG for night-time grilling. Weather-resistant design.",
    price: "$29.99",
  ...
  },
  {
    ...
    description:
      "Heat-resistant glove for safely handling hot EGG components. Protects up to 450°F/232°C.",
    price: "$24.99",
  ...
  },
  {
    ...
    description:
      "Ceramic egg-shaped salt and pepper shakers in the classic Big Green Egg color.",
    price: "$19.99",
  ...
  },
  {
    ...
    description:
      "Comprehensive cookbook with hundreds of recipes specifically designed for cooking on the EGG.",
    price: "$39.99",
  ...
  },
  {
    ...
    description:
      "Premium acacia wood cutting board with the Big Green Egg logo. Perfect for prepping and serving.",
    price: "$44.99",
  ...
  // Additional Tables & Modular Systems
  {
    ...
    description:
      "DIY frame kit to build your own custom island for your Large EGG. Includes frame, hardware, and instructions.",
    price: "$499.99",
  ...
  },
  {
    ...
    description:
      "DIY frame kit to build your own custom island for your XL EGG. Includes frame, hardware, and instructions.",
    price: "$549.99",
  ...
  },
  {
    ...
    description:
      "Premium solid mahogany table for your Large EGG. Beautiful, weather-resistant, and built to last.",
    price: "$899.99",
  ...
  },
  {
    ...
    description:
      "Premium solid cypress table for your XL EGG. Natural resistance to weather and insects.",
    price: "$849.99",
  ...
  },
  {
    ...
    description:
      "Expand your modular nest system with this additional frame. Compatible with all inserts.",
    price: "$199.99",
  ...
  },
  {
    ...
    description:
      "Connect multiple modular nest components securely with this hardware kit.",
    price: "$49.99",
  ...
  },
  {
    ...
    description:
      "Premium teak wood insert for the modular nest system. Natural oils make it weather resistant.",
    price: "$149.99",
  ...
  },
  {
    ...
    description:
      "Securely store your propane tank in this holder that integrates with the modular nest system.",
    price: "$79.99",
  ...
  // Additional Bases and Stands
  {
    ...
    description:
      "Folding stand designed specifically for the MiniMax EGG. Perfect for camping and tailgating.",
    price: "$89.99",
  ...
  },
  {
    ...
    name: "Table Nest",
    description:
      "Raises your EGG off the table surface to prevent heat transfer and potential damage.",
    price: "From $29.99",
  ...
  },
  {
    ...
    description:
      "Heavy-duty rolling cart with locking wheels for your Large EGG. Includes storage space for accessories.",
    price: "$249.99",
  ...
  },
  {
    ...
    description:
      "Heavy-duty nest with handles designed specifically for the 2XL EGG. Makes moving your EGG safe and easy.",
    price: "$299.99",
  ...
  // Additional Accessories
  {
    ...
    description:
      "5.5 quart enameled cast iron Dutch oven perfect for stews, soups, and braising in your EGG.",
    price: "$129.99",
  ...
  },
  {
    ...
    description:
      "Create perfect, uniform burgers with this heavy-duty cast iron press. Includes wooden handle.",
    price: "$24.99",
  ...
  },
  {
    ...
    description:
      "Perfect for cooking smaller foods that might fall through a standard grid. Made of stainless steel.",
    price: "From $39.99",
  ...
  },
  {
    ...
    description:
      "Perfect for stuffed peppers, onions, and other foods that need to stand upright while cooking.",
    price: "$29.99",
  ...
  },
  {
    ...
    description:
      "Strong, earthy smoke flavor perfect for beef, pork, and game meats. Made from real mesquite wood.",
    price: "$14.99",
  ...
  },
  {
    ...
    description:
      "Chemical-free fire starters made from wood shavings and paraffin. Quick and easy lighting every time.",
    price: "$12.99",
  ...
  },
  {
    ...
    description:
      "Collects ash for easy cleanup. Slides under the firebox and easily removes for disposal.",
    price: "From $59.99",
  ...
  },
  {
    ...
    description:
      "Dual-action brush with stainless steel bristles on one side and scraper on the other. Includes long handle for safety.",
    price: "$19.99",
  ...
  },
  {
    ...
    description:
      "Heavy-duty weatherproof cover designed specifically for the 2XL EGG. Protects from elements and UV rays.",
    price: "$89.99",
  ...
  },
  {
    ...
    description:
      "Heavy-duty weatherproof cover designed specifically for the MiniMax EGG. Protects from elements and UV rays.",
    price: "$49.99",
  ...
  },
  {
    ...
    description:
      "Heavy-duty rotisserie system that works with the EGGspander. Perfect for whole chickens, roasts, and more.",
    price: "$249.99",
  ...
  },
  {
    ...
    description:
      "Creates a second level of cooking area on half of your EGG. Perfect for multi-zone cooking.",
    price: "From $49.99",
  ...
  },
  {
    ...
    description:
      "Heavy-duty replacement hinge assembly for your Big Green Egg.",
    price: "From $79.99",
  ...
  },
  {
    ...
    description:
      "Complete metal band assembly including hinges for your Big Green Egg.",
    price: "From $119.99",
  ...
  },
  {
    ...
    description:
      "Replacement daisy wheel and damper top for precise temperature control.",
    price: "From $49.99",
  ...
  },
  {
    ...
    description:
      "Original replacement stainless steel cooking grid for your Big Green Egg.",
    price: "From $41.99",
  ...
  },
  {
    ...
    description:
      "Replacement bottom vent door for airflow control on your Big Green Egg.",
    price: "From $24.99",
...
function getEggSizeFromQuery(query: string): string {
  ...
  console.log("DEBUG: getEggSizeFromQuery called with:", lowerQuery);
  ...
  const eggSizeVariations = [
    ...
    {
      variations: ["minimax", "mini max", "mini-max", "mini-m", "minm"],
      size: "minimax",
    },
  ...
  for (const sizeGroup of eggSizeVariations) {
    for (const variation of sizeGroup.variations) {
      if (lowerQuery.includes(variation)) {
        ...
        console.log(
          `DEBUG: Found match: '${variation}' -> size: '${targetSize}'`
        );
        break;
      }
    }
  ...
  console.log("DEBUG: Final targetSize:", targetSize);
  return targetSize;
}

// Helper function to map size string to product ID pattern
function mapSizeToProductId(size: string): string {
  console.log("DEBUG: mapSizeToProductId called with:", size);
  const result = (() => {
  ...
  console.log("DEBUG: mapSizeToProductId result:", result);
  return result;
}
...
export function searchProducts(query: string, maxResults = 5): Product[] {
  const lowerQuery = query.toLowerCase();
  console.log("DEBUG: searchProducts called with:", lowerQuery);

  // Handle cooking capacity based recommendations
  const capacityMatches = lowerQuery.match(
    /(\d+)\s*(?:people|persons|guests|family|crowd|group)/i
  );
  if (capacityMatches && capacityMatches[1]) {
    ...
    if (peopleCount > 0) {
      const recommendedEgg = recommendEggBasedOnCapacity(peopleCount);
      if (recommendedEgg) {
        console.log(
          `DEBUG: Recommending ${recommendedEgg.name} for ${peopleCount} people`
        );
        return [recommendedEgg];
      }
    }
  }
  ...
  if (
    lowerQuery.includes("egg genius") ||
    lowerQuery.includes("temperature controller")
  ) {
    return products.filter((p) => p.id === "egg-genius");
  }

  // Enhanced explicit product checks for common size confusions
  // Make sure "mini" queries don't match "minimax" unless specifically requested
  if (
    lowerQuery.includes("mini egg") &&
    !lowerQuery.includes("minimax") &&
    !lowerQuery.includes("mini max")
  ) {
    console.log("DEBUG: Direct Mini Egg match found");
    return products.filter((p) => p.id === "mini-egg");
  }

  // Explicit small egg check
  if (lowerQuery.includes("small egg")) {
    console.log("DEBUG: Direct Small Egg match found");
    return products.filter((p) => p.id === "small-egg");
  }

  // Direct MiniMax search optimization
  if (
    lowerQuery.includes("minimax") ||
    lowerQuery.includes("mini max") ||
    lowerQuery.includes("mini-max")
  ) {
    console.log("DEBUG: Direct MiniMax match found");
    // Check if this is a dimension or specification query
    if (
      lowerQuery.includes("dimension") ||
      lowerQuery.includes("size") ||
      lowerQuery.includes("how big") ||
      lowerQuery.includes("how tall") ||
      lowerQuery.includes("height") ||
      lowerQuery.includes("width") ||
      lowerQuery.includes("specification") ||
      lowerQuery.includes("specs") ||
      lowerQuery.includes("weight") ||
      lowerQuery.includes("cooking area")
    ) {
      console.log("DEBUG: Returning MiniMax product directly");
      return products.filter((p) => p.id === "minimax-egg");
    }
  }
  ...
  if (
    ...
    console.log("DEBUG: Dimension query detected, targetSize:", targetSize);

    if (targetSize) {
      const productId = mapSizeToProductId(targetSize);
      console.log("DEBUG: Looking for product with ID:", productId);

      // Extra safety check to ensure we get the right egg
      if (
        productId === "mini-egg" &&
        lowerQuery.includes("mini") &&
        !lowerQuery.includes("minimax")
      ) {
        console.log("DEBUG: Specifically targeting Mini Egg");
        return products.filter((p) => p.id === "mini-egg");
      } else if (productId === "small-egg" && lowerQuery.includes("small")) {
        console.log("DEBUG: Specifically targeting Small Egg");
        return products.filter((p) => p.id === "small-egg");
      } else {
        const matchingProducts = products.filter((p) => p.id === productId);
        console.log(
          "DEBUG: Found matching products:",
    ...
    return products
      .filter((p) => p.specifications?.dimensions)
      .slice(0, maxResults);
  }
  ...
  if (
    lowerQuery.includes("cooking area") ||
    lowerQuery.includes("cooking surface") ||
    lowerQuery.includes("cooking space") ||
    lowerQuery.includes("grid size") ||
    lowerQuery.includes("how much can fit")
  ) {
    const targetSize = getEggSizeFromQuery(lowerQuery);
    console.log("DEBUG: Cooking area query detected, targetSize:", targetSize);
    ...
    return products
      .filter((p) => p.specifications?.cookingArea)
      .slice(0, maxResults);
  }

  // Special case handling for common product searches
  if (
    lowerQuery.includes("pizza stone") ||
    lowerQuery.includes("baking stone")
  ) {
    const pizzaStones = products.filter(
      (p) =>
  ...
  if (
    ...
    lowerQuery.includes("expander") ||
    lowerQuery.includes("multi level") ||
    lowerQuery.includes("multilevel")
  ) {
  ...
  if (
    lowerQuery.includes("conveggtor") ||
    lowerQuery.includes("plate setter") ||
    lowerQuery.includes("heat deflector")
  ) {
  ...
  if (
    lowerQuery.includes("weight") ||
    lowerQuery.includes("how heavy") ||
    lowerQuery.includes("how much does") ||
    lowerQuery.includes("pounds") ||
    lowerQuery.includes("lbs")
  ) {
    const targetSize = getEggSizeFromQuery(lowerQuery);
    ...
    return products
      .filter((p) => p.category === "Eggs" && p.specifications?.weight)
      .slice(0, maxResults);
  }

  if (
    lowerQuery.includes("thermometer") ||
    lowerQuery.includes("temperature probe")
  ) {
  ...
  if (
    lowerQuery.includes("smoking chips") ||
    lowerQuery.includes("wood chips")
  ) {
    return products.filter(
      (p) =>
        p.id === "whiskey-chips" ||
  ...
  const scoredProducts = products.map((product) => {
    ...
    if (product.specifications) {
      ...
      if (
        ...
        product.specifications.weight
          ...
          .includes(
            lowerQuery
              .replace(/weight|heavy|pounds|lbs|how much does|weigh/g, "")
              .trim()
          )
      ) {
        score += 40;
      ...
      // Check cooking area
      if (
        product.specifications.cookingArea &&
        (lowerQuery.includes("cooking area") ||
          lowerQuery.includes("cooking surface") ||
          lowerQuery.includes("how much can fit"))
      ) {
    ...
    if (
      ...
      product.name
        .toLowerCase()
        .includes(lowerQuery.replace(/buy|purchase|want|get|need/g, "").trim())
    ) {
      score += 40;
    }
...
export function generateProductResponse(products: Product[]): string {
  ...
  if (products.length === 1) {
    ...
    response +=
      "Would you like more information about this product or would you like to see other options?";
  ...
  products.forEach((product) => {
    ...
    if (product.specifications) {
      if (
        ...
        if (product.specifications.weight) {
          response += `Weight: ${
            product.specifications.weight.split(" ")[0]
          } lbs | `;
        }

        if (product.specifications.cookingArea) {
          response += `Cooking Area: ${
            product.specifications.cookingArea.split(" ")[0]
          } sq in | `;
        }
...
// Add a new function specifically for recommending eggs based on cooking capacity
export function recommendEggBasedOnCapacity(
  peopleCount: number
): Product | null {
  console.log("DEBUG: Recommending egg for", peopleCount, "people");

  // Define egg size recommendations based on cooking capacity
  if (peopleCount >= 15) {
    // Commercial or very large gatherings
    console.log("DEBUG: Recommending 2XL for large group");
    return products.find((p) => p.id === "2xl-egg") || null;
  } else if (peopleCount >= 8) {
    // Large family or entertaining
    console.log("DEBUG: Recommending XL for medium-large group");
    return products.find((p) => p.id === "xl-egg") || null;
  } else if (peopleCount >= 4) {
    // Average family
    console.log("DEBUG: Recommending Large for average family");
    return products.find((p) => p.id === "large-egg") || null;
  } else if (peopleCount >= 2) {
    // Couple or small family
    console.log("DEBUG: Recommending Medium for small family");
    return products.find((p) => p.id === "medium-egg") || null;
  } else {
    // Individual
    console.log("DEBUG: Recommending Small/MiniMax for individual");
    return (
      products.find((p) => p.id === "small-egg" || p.id === "minimax-egg") ||
      null
    );
  }
}
